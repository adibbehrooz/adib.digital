const positions = {
	...
	webpack: {
		...
		inside: [
			{ form: 'save'},
				...
				{ form: 'lineWidth', value: '1' },
				{ form: 'strokeStyle',	value: 'rgba(255, 255, 255, 0.4)' },
				{ form: 'stroke'},
			{ form: 'restore' },	
		],
		arc: [
	...
	svg: {
		...
		inside: [
			{ form: 'save'},
			{ form: 'beginPath' }, 
			{ x0: 0.23538, 	x1: 9.52383, 	form: 'moveTo' },
			{ x0: 18.23538, x1: 9.52383, 	form: 'lineTo' },
			{ x0: 9.53538, 	x1: 15.52383, 	form: 'moveTo' },
			{ x0: 9.53538, 	x1: 2.5238, 	form: 'lineTo' },
			{ x0: 15.23538, x1: 3.5238, 	form: 'moveTo' },
			{ x0: 2.33538, 	x1: 16.72383, 	form: 'lineTo' },
		...
		arc: [
			{ form: 'save'},
			{ x0: 5.23538, 	x1: 14.22383 },
			{ x0: 23.23538, x1: 14.22383 },
			{ x0: 14.23538, x1: 23.52383 },
			{ x0: 14.23538, x1: 4.523800 },
			{ x0: 20.23538, x1: 7.523800 },
			{ x0: 7.33538, 	x1: 21.72383 },
			{ x0: 14.23538, x1: 13.62383 },
			{ x0: 6.83538, 	x1: 6.323800 },	
			{ x0: 20.83538, x1: 20.12383 },
			{ form: 'restore' },
		]
	},
	...
	javascript: {
		...
		outside: [
			...
			{ form: 'strokeStyle', value: "rgba(255, 255, 255, .1)" }, 
			{ form: 'miterLimit', value: 4 }, 
			{ x0: 0.1107936507936508, x1: 0.1107936507936508,  form: 'scale' },
			{ x0: 3.7795275590551185, x1: 3.7795275590551185,  form: 'scale' },
			{ form: 'save' }, 
			{ form: 'fillStyle', value: "rgba(255, 255, 255, .1)" }, 
			{ form: 'fillStyle', value: "rgba(255, 255, 255, .1)" }, 
			{ form: 'strokeStyle', value: "rgba( 255, 255, 255, .1)" }, 
