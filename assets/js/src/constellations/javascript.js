...
const javascript = {
	...
	coordination: {
        ...
        boundary: [
			{ form: 'save' },
                { form: 'beginPath' }, 
				{ x0: -80.000,      x1: -90.000, form: 'moveTo' }, 
				{ x0: 30.000,     	x1: -90.000, form: 'lineTo' }, 
				{ x0: 30.000,      	x1: 10.000, form: 'lineTo' }, 
				{ x0: -80.000,      x1: 10.000, form: 'lineTo' }, 
				{ x0: -80.000,      x1: -90.000, form: 'lineTo' }, 
                { form: 'closePath' },
				// Stroke
