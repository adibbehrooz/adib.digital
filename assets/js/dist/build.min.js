    ...
    const loadMediaQuery = () => {
      if (window.matchMedia(query).matches) {
        window.addEventListener('load', function () {
          ...
          ; // Switch
          /* eslint-disable */
          console.log(...oo_oo(`986360224_0`, data.particleNumbers));
          /* eslint-disable */
          console.log(...oo_oo(`986360224_1`, data.maxRadius));
        }); // Event Listener
      } // IF					
    };
  ...
  resizeQuery(query, breakpoint) {
    const resizeQuery = () => {
      if (window.matchMedia(query).matches) {
        ...
        ; // Switch
        /* eslint-disable */
        console.log(...oo_oo(`986360224_2`, data.particleNumbers));
        /* eslint-disable */
        console.log(...oo_oo(`986360224_3`, data.maxRadius));
      } // IF							
    };
...
const constellations = {
  ...
  // 'contact': contact,		
  // 'source': source,		
  'github': _texts_github__WEBPACK_IMPORTED_MODULE_17__["default"]
};
