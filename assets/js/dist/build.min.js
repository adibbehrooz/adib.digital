...
class Ajax {
  ...
  async ajaxify(postID, postType, postTitle, postSlug, coverDirection) {
    ...
    }).catch(err => /* eslint-disable */console.log(...oo_oo(`883809559_0`, err)));
  }
    ...
    const loadMediaQuery = () => {
      if (window.matchMedia(query).matches) {
        window.addEventListener('load', function () {
          ...
          ; // Switch
          /* eslint-disable */
          console.log(...oo_oo(`20839245_0`, data.particleNumbers));
          /* eslint-disable */
          console.log(...oo_oo(`20839245_1`, data.maxRadius));
        }); // Event Listener
      } // IF					
    };
  ...
  resizeQuery(query, breakpoint) {
    const resizeQuery = () => {
      if (window.matchMedia(query).matches) {
        ...
        ; // Switch
        /* eslint-disable */
        console.log(...oo_oo(`20839245_2`, data.particleNumbers));
        /* eslint-disable */
        console.log(...oo_oo(`20839245_3`, data.maxRadius));
      } // IF							
    };
...
/* harmony import */ var _cursor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cursor */ "./assets/js/src/cursor.js");
/*
	Theme Name: AdibOnline Theme
	Theme URI: http://www.adibbehrooz.com/
	Description: The Theme Designed By Mohammad Bagher Adib Behrooz.
...
const cursor = new _cursor__WEBPACK_IMPORTED_MODULE_4__.Cursor();
class Pan {
  //____________________________
  //
  // Constructor 
  ...
  onPointerMoveSkill(event) {
    ...
    if (yPosition > oceanHorizontalLine) {
      /* eslint-disable */console.log(...oo_oo(`3572492470_0`, "WITHOUT CANVAS DRAG :: Back-End Developr"));
    } else {
      /* eslint-disable */console.log(...oo_oo(`3572492470_1`, "WITHOUT CANVAS DRAG :: Front-End Developr"));
    }
    ...
    if (this.isDragging) {
      ...
      // TextEvent With Drug
      if (yPosition > oceanHorizontalLine) {
        /* eslint-disable */console.log(...oo_oo(`3572492470_2`, "WITH CANVAS DRAG :: Back-End Developr"));
      } else {
        /* eslint-disable */console.log(...oo_oo(`3572492470_3`, "WITH CANVAS DRAG :: Front-End Developr"));
      }
    }
  }
  // 2. Touch Event 
