...
class Ajax {
  ...
  modalContainer(postID, postType, coverDirection, modalClass, activeClass, deactiveClass) {
    ...
    if (modalClass.classList.contains(activeClass)) {
      // I. Modal is open
  ...
  ajaxify(postID, postType, coverDirection) {
    ...
    fetch(ajax_custom.ajaxurl, {
      method: 'POST',
      body: formData
    }).then(res => res.text(), this.modalContainer(postID, postType, coverDirection, modalClass, activeClass, deactiveClass)).then(data => document.getElementById(this.modalID).innerHTML = data).catch(err => console.log(err));
  }
}
;
