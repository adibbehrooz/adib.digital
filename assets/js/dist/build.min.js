...
class Ajax {
  ...
  **/
  ...
  async ajaxify(postID, postType, coverDirection) {
    ...
    }).then(this.modalCloseButtonEvent(postID, postType, coverDirection, modalClass, activeClass, deactiveClass)).catch(err => console.log(err));
  }
}
;
...
class Screens {
  ...
  matchMediaScreens() {
    ...
    // Using array methods
    let mediaQuery = [];
    Object.entries(screensValues).forEach(_ref => {
      let [key, screensValue] = _ref;
      Object.entries(screensValue).forEach(_ref2 => {
        let [value, index] = _ref2;
...
const screens = new _canvas__WEBPACK_IMPORTED_MODULE_0__.Screens();
