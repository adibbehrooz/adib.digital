...
class Text {
  ...
  hideToShowText(classNameToShow, classNameToHide) {
    ...
    if (textVisible.classList.contains(this.activeTextClass)) {
      // I. Text is Visible
...
const texts = new _texts__WEBPACK_IMPORTED_MODULE_3__.Texts();
class Pan {
  //____________________________
  //
  // Constructor 
