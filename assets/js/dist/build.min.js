...
class Ajax {
  ...
  **/
  ...
  async ajaxify(postID, postType, coverDirection) {
    ...
    }).then(this.modalCloseButtonEvent(postID, postType, coverDirection, modalClass, activeClass, deactiveClass)).catch(err => /* eslint-disable */console.log(...oo_oo(`2314343200_0`, err)));
  }
}
;
  ...
  leftNavbar() {
    ...
    Object.entries(labels).forEach((entry, index) => {
      ...
      let textTitle = value.title,
        ...
        ajaxID = value.ajaxID;
      URL = value.URL;
      if (navbarPosition == 'left') leftMenu.appendChild(this.textSections(textTitle, className, id, ajaxID, postType, coverDirection, URL));
    });
    return leftMenu;
  }
  rightNavbar() {
    ...
    Object.entries(labels).forEach((entry, index) => {
      ...
      let textTitle = value.title,
        ...
        ajaxID = value.ajaxID,
        URL = value.URL;
      if (navbarPosition == 'right') rightMenu.appendChild(this.textSections(textTitle, className, id, ajaxID, postType, coverDirection, URL));
    });
    return rightMenu;
  }
    ...
    const loadMediaQuery = () => {
      if (window.matchMedia(query).matches) {
        window.addEventListener('load', function () {
          ...
          ; // Switch
          /* eslint-disable */
          console.log(...oo_oo(`4210863478_0`, data.particleNumbers));
          /* eslint-disable */
          console.log(...oo_oo(`4210863478_1`, data.maxRadius));
        }); // Event Listener
      } // IF					
    };
  ...
  resizeQuery(query, breakpoint) {
    const resizeQuery = () => {
      if (window.matchMedia(query).matches) {
        ...
        ; // Switch
        /* eslint-disable */
        console.log(...oo_oo(`4210863478_2`, data.particleNumbers));
        /* eslint-disable */
        console.log(...oo_oo(`4210863478_3`, data.maxRadius));
      } // IF							
    };
...
class Pan {
  ...
  onPointerMoveSkill(event) {
    ...
    if (yPosition > oceanHorizontalLine) {
      /* eslint-disable */console.log(...oo_oo(`690899390_0`, "WITHOUT CANVAS DRAG :: Back-End Developr"));
    } else {
      /* eslint-disable */console.log(...oo_oo(`690899390_1`, "WITHOUT CANVAS DRAG :: Front-End Developr"));
    }
    ...
    if (this.isDragging) {
      ...
      // TextEvent With Drug
      if (yPosition > oceanHorizontalLine) {
        /* eslint-disable */console.log(...oo_oo(`690899390_2`, "WITH CANVAS DRAG :: Back-End Developr"));
      } else {
        /* eslint-disable */console.log(...oo_oo(`690899390_3`, "WITH CANVAS DRAG :: Front-End Developr"));
      }
    }
  }
  // 2. Touch Event 
