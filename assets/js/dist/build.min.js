...
class Ajax {
  ...
  **/
  ...
  async ajaxify(postID, postType, postTitle, postSlug, coverDirection) {
    ...
    }).catch(err => /* eslint-disable */console.log(...oo_oo(`2404868030_0`, err)));
  }
    ...
    const loadMediaQuery = () => {
      if (window.matchMedia(query).matches) {
        window.addEventListener('load', function () {
          ...
          ; // Switch
          /* eslint-disable */
          console.log(...oo_oo(`3132442884_0`, data.particleNumbers));
          /* eslint-disable */
          console.log(...oo_oo(`3132442884_1`, data.maxRadius));
        }); // Event Listener
      } // IF					
    };
  ...
  resizeQuery(query, breakpoint) {
    const resizeQuery = () => {
      if (window.matchMedia(query).matches) {
        ...
        ; // Switch
        /* eslint-disable */
        console.log(...oo_oo(`3132442884_2`, data.particleNumbers));
        /* eslint-disable */
        console.log(...oo_oo(`3132442884_3`, data.maxRadius));
      } // IF							
    };
...
class Pan {
  ...
  onPointerMoveSkill(event) {
    ...
    if (yPosition > oceanHorizontalLine) {
      /* eslint-disable */console.log(...oo_oo(`3358787437_0`, "WITHOUT CANVAS DRAG :: Back-End Developr"));
    } else {
      /* eslint-disable */console.log(...oo_oo(`3358787437_1`, "WITHOUT CANVAS DRAG :: Front-End Developr"));
    }
    ...
    if (this.isDragging) {
      ...
      // TextEvent With Drug
      if (yPosition > oceanHorizontalLine) {
        /* eslint-disable */console.log(...oo_oo(`3358787437_2`, "WITH CANVAS DRAG :: Back-End Developr"));
      } else {
        /* eslint-disable */console.log(...oo_oo(`3358787437_3`, "WITH CANVAS DRAG :: Front-End Developr"));
      }
    }
  }
  // 2. Touch Event 
...
class Menu {
  ...
  skillText(canvaWidth, ctx, cameraOffset) {
    ...
    ctx.fillText("FRONT-END DEVELOPER", window.innerWidth - window.innerWidth / 1.11, cameraOffset.y - window.innerHeight / 2.4);
    ctx.fillText("BACK-END DEVELOPER", window.innerWidth - window.innerWidth / 1.11, cameraOffset.y + window.innerHeight * .37);
  }
