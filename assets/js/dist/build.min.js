...
class Pan {
  ...
  sillText() {
    ...
    this.ctx.fillText("FRONT-END DEVELOPER", window.innerWidth - window.innerWidth / 1.06, this.cameraOffset.y - window.innerHeight / 2.4);
    this.ctx.fillText("BACK-END DEVELOPER", window.innerWidth - window.innerWidth / 1.06, this.cameraOffset.y + window.innerHeight * .37);
  }
