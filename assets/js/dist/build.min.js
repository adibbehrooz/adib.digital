...
class Pan {
  ...
  straightlines(shapeName, lineType) {
    ...
    for (let i = 1; i < _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType].length; i++) {
      ...
      switch (form) {
        case 'scale':
          this.ctx.scale(_positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1']);
          break;
        case 'miterLimit':
          this.ctx.miterLimit = _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['value'];
          break;
        case 'moveTo':
          this.ctx.moveTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType]);
          break;
        case 'lineTo':
          this.ctx.lineTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType]);
          break;
        case "translate":
          this.ctx.translate(_positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1']);
          break;
        case 'transform':
          this.ctx.transform(_positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x2'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x3'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x4'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x5']);
          break;
        case 'bezierCurveTo':
          this.ctx.bezierCurveTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x2'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x3'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x4'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x5'] * this.srp[shapeName]['size'][lineType]);
          break;
        case 'fillRect':
          this.ctx.fillRect(_positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x2'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x3']);
          break;
        case 'fillText':
          this.ctx.fillText(_positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x2'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x3']);
          break;
        case 'arc':
          this.ctx.arc(_positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x2'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x3'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x4'], _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x5']);
          break;
        case 'closePath':
          this.ctx.closePath();
          break;
        ...
        case 'save':
          ...
          break;
        case 'lineWidth':
          this.ctx.lineWidth = _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['value']; // this.ctx.lineWidth = this.srp[shapeName]['width'][lineType]; 
        ...
        case 'stroke':
          ...
          break;
        case 'strokeStyle':
          this.ctx.strokeStyle = _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['value'];
          break;
        case 'fill':
          this.ctx.fill();
          break;
        case 'fillStyle':
          this.ctx.fillStyle = _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['value'];
          break;
      }
      ; // [END] SWITCH
    }
  ...
  shapeStars(shapeName) {
    ...
    const render = () => {
      for (let i = 0; i < _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType].length; i++) {
        this.ctx.beginPath();
        this.ctx.arc(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.scaleSize, this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.scaleSize, randomRadius, 0, 2 * Math.PI, false);
  ...
  shapeEvent(cursor, shapeName, offsetX, offsetY) {
    ...
    this.ctx.beginPath();
    shape.moveTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][0]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][0]['x1'] * this.srp[shapeName]['size'][lineType]);
    for (let i = 1; i < _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType].length; i++) {
      shape.lineTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType]);
    }
...
const positions = {
  ...
  javascript: {
    ...
    outside: [{
      ...
      x0: 0.1107936507936508,
      x1: 0.1107936507936508,
      form: 'scale'
    }, {
      x0: 3.7795275590551185,
      x1: 3.7795275590551185,
      form: 'scale'
    }, {
      form: 'save'
    }, {
