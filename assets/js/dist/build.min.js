...
/* harmony import */ var _landscape_mountains__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./landscape/mountains */ "./assets/js/src/landscape/mountains.js");
/* harmony import */ var _landscape_shore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./landscape/shore */ "./assets/js/src/landscape/shore.js");
/* harmony import */ var _landscape_ocean__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./landscape/ocean */ "./assets/js/src/landscape/ocean.js");
/*
	Theme Name: AdibOnline Theme
	Theme URI: http://www.adibbehrooz.com/
	Description: The Theme Designed By Mohammad Bagher Adib Behrooz.
...
const landscape = {
  'mountains': _landscape_mountains__WEBPACK_IMPORTED_MODULE_5__["default"],
  'shore': _landscape_shore__WEBPACK_IMPORTED_MODULE_6__["default"],
  'ocean': _landscape_ocean__WEBPACK_IMPORTED_MODULE_7__["default"]
  // 'aurora':		aurora
};
...
/***/ "./assets/js/src/landscape/mountains.js":
/*!**********************************************!*\
  !*** ./assets/js/src/landscape/mountains.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/js/src/landscape/ocean.js":
/*!******************************************!*\
  !*** ./assets/js/src/landscape/ocean.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    for (let i = 0; i < constellation[name].coordination[lineType].length; i++) {
      ...
      switch (form) {
        ...
        case "translate":
          ...
          break;
        case 'transform':
          context.transform(constellation[name].coordination[lineType][i]['x0'], constellation[name].coordination[lineType][i]['x1'], constellation[name].coordination[lineType][i]['x2'], constellation[name].coordination[lineType][i]['x3'], constellation[name].coordination[lineType][i]['x4'], constellation[name].coordination[lineType][i]['x5']);
          break;
        case 'bezierCurveTo':
          ...
          break;
        case 'fillRect':
          context.fillRect(constellation[name].coordination[lineType][i]['x0'], constellation[name].coordination[lineType][i]['x1'], constellation[name].coordination[lineType][i]['x2'], constellation[name].coordination[lineType][i]['x3']);
          break;
        case 'fillText':
          ...
          break;
        case 'arc':
          context.arc(constellation[name].coordination[lineType][i]['x0'], constellation[name].coordination[lineType][i]['x1'], constellation[name].coordination[lineType][i]['x2'], constellation[name].coordination[lineType][i]['x3'], constellation[name].coordination[lineType][i]['x4'], constellation[name].coordination[lineType][i]['x5']);
          break;
        case 'closePath':
          context.closePath();
          break;
...
/* harmony import */ var _constellations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constellations */ "./assets/js/src/constellations.js");
...
class Pan {
  ...
  environment() {
    ...
    Object.entries(_constellations__WEBPACK_IMPORTED_MODULE_1__.landscape).forEach((entry, index) => {
  ...
  shapes() {
    // Translate Shapes
    this.ctx.translate(-(window.innerWidth / 2) + this.cameraOffset.x, -(window.innerHeight / 2) + this.cameraOffset.y);
    Object.entries(_constellations__WEBPACK_IMPORTED_MODULE_1__.constellations).forEach((entry, index) => {
      const [key, value] = entry;
