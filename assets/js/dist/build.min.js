...
class Pan {
  ...
  position() {
    const position = {
      ...
      webpack: {
        relation: {
          x: window.innerWidth / 1.200 - window.innerWidth / 2,
    ...
    for (let i = 1; i < _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType].length; i++) {
      ...
      switch (form) {
        ...
        case 'miterLimit':
          ...
          break;
        case 'moveTo':
          this.ctx.moveTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.scaleSize, this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.scaleSize);
          break;
        case 'lineTo':
          this.ctx.lineTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.scaleSize, this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.scaleSize);
          break;
        case "translate":
        ...
        case 'save':
          ...
          break;
        case 'lineWidth':
          this.ctx.lineWidth = _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['value'];
          break;
        case 'stroke':
          this.ctx.stroke();
          break;
  ...
  shapeEvent(cursor, shapeName, offsetX, offsetY) {
    ...
    this.ctx.beginPath();
    shape.moveTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][0]['x0'] * this.scaleSize, this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][0]['x1'] * this.scaleSize);
    for (let i = 1; i < _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType].length; i++) {
      shape.lineTo(this.srp[shapeName]['relation']['x'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x0'] * this.scaleSize, this.srp[shapeName]['relation']['y'] + _positions__WEBPACK_IMPORTED_MODULE_0__.positions[shapeName][lineType][i]['x1'] * this.scaleSize);
    }
...
const positions = {
  ...
  webpack: {
    ...
    outside: [{
      ...
      x0: 0.1007936507936508,
      x1: 0.1007936507936508,
      form: 'scale'
    }, {
      x0: 10,
      x1: 10,
