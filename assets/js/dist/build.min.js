...
class Pan {
  ...
  curveLines(shapeName) {
    ...
    _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName].curve(context);
  }
  straightlines(shapeName, lineType) {
    // Draw Lines
    for (let i = 1; i < _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType].length; i++) {
      let form = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['form'];
      switch (form) {
        case 'scale':
          this.ctx.scale(_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1']);
          break;
        case 'miterLimit':
          this.ctx.miterLimit = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['value'];
          break;
        case 'moveTo':
          this.ctx.moveTo(this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType]);
          break;
        case 'lineTo':
          this.ctx.lineTo(this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType]);
          break;
        case "translate":
          this.ctx.translate(_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1']);
          break;
        case 'transform':
          this.ctx.transform(_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x2'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x3'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x4'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x5']);
          break;
        case 'bezierCurveTo':
          this.ctx.bezierCurveTo(this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x2'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x3'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x4'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x5'] * this.srp[shapeName]['size'][lineType]);
          break;
        case 'fillRect':
          this.ctx.fillRect(_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x2'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x3']);
          break;
        case 'fillText':
          this.ctx.fillText(_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x2'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x3']);
          break;
        case 'arc':
          this.ctx.arc(_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x2'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x3'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x4'], _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x5']);
          break;
        case 'closePath':
          this.ctx.closePath();
          break;
        ...
        case 'save':
          ...
          break;
        case 'lineWidth':
          this.ctx.lineWidth = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['value']; // this.ctx.lineWidth = this.srp[shapeName]['width'][lineType]; 
        ...
        case 'strokeStyle':
          // For Gradient
          if (_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['type'] == 'gradient') {
            if (_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['key'] == 'addColorStop') {
              _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['name'] + '.addColorStop' + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['value'];
            }
            this.ctx.strokeStyle = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['name'];
          }
          // For Numbers
          else {
            this.ctx.strokeStyle = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['value'];
          }
          break;
        case 'fill':
          this.ctx.fill();
        ...
        case 'fillStyle':
          ...
          if (_constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['type'] == 'gradient') {
            ...
            this.ctx.fillStyle = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['name'];
          }
          // For Numbers
          else {
            this.ctx.fillStyle = _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['value'];
          }
          break;
      }
      ; // [END] SWITCH
  ...
  shapeStars(shapeName) {
    ...
    // 2. Update
    const update = () => {
      for (let i = 0; i < _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType].length; i++) {
    ...
    const render = () => {
      for (let i = 0; i < _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType].length; i++) {
        this.ctx.beginPath();
        this.ctx.arc(this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'] * this.scaleSize, this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'] * this.scaleSize, randomRadius, 0, 2 * Math.PI, false);
  ...
  shapeEvent(cursor, shapeName, offsetX, offsetY, eventName) {
    ...
    this.ctx.beginPath();
    shape.moveTo(this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][0]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][0]['x1'] * this.srp[shapeName]['size'][lineType]);
    for (let i = 1; i < _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType].length; i++) {
      shape.lineTo(this.srp[shapeName]['relation']['x'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x0'] * this.srp[shapeName]['size'][lineType], this.srp[shapeName]['relation']['y'] + _constellations__WEBPACK_IMPORTED_MODULE_0__.constellations[shapeName][lineType][i]['x1'] * this.srp[shapeName]['size'][lineType]);
    }
