...
class Ajax {
  ...
  **/
  ...
  async ajaxify(postID, postType, coverDirection) {
    ...
    }).then(this.modalCloseButtonEvent(postID, postType, coverDirection, modalClass, activeClass, deactiveClass)).catch(err => /* eslint-disable */console.log(...oo_oo(`1396093957_0`, err)));
  }
}
;
...
class Sections {
  ...
  textCursor() {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`2401815636_0`, links));
    const gsapCursor = {
      'links': links
    };
    Object.keys(gsapCursor).forEach(key => {
      gsapCursor[key].forEach((value, index) => {
        /* eslint-disable */console.log(...oo_oo(`2401815636_1`, value));
        value.classList.add('zoom');
        value.addEventListener('mouseover', () => {
          value.classList.add('zoom');
          // GSAP
    ...
    const loadMediaQuery = () => {
      if (window.matchMedia(query).matches) {
        window.addEventListener('load', function () {
          ...
          ; // Switch
          /* eslint-disable */
          console.log(...oo_oo(`2401815636_2`, data.particleNumbers));
          /* eslint-disable */
          console.log(...oo_oo(`2401815636_3`, data.maxRadius));
        }); // Event Listener
      } // IF					
    };
  ...
  resizeQuery(query, breakpoint) {
    const resizeQuery = () => {
      if (window.matchMedia(query).matches) {
        ...
        ; // Switch
        /* eslint-disable */
        console.log(...oo_oo(`2401815636_4`, data.particleNumbers));
        /* eslint-disable */
        console.log(...oo_oo(`2401815636_5`, data.maxRadius));
      } // IF							
    };
...
class Pan {
  ...
  onPointerMoveSkill(event) {
    ...
    if (yPosition > oceanHorizontalLine) {
      /* eslint-disable */console.log(...oo_oo(`2694664437_0`, "WITHOUT CANVAS DRAG :: Back-End Developr"));
    } else {
      /* eslint-disable */console.log(...oo_oo(`2694664437_1`, "WITHOUT CANVAS DRAG :: Front-End Developr"));
    }
    ...
    if (this.isDragging) {
      ...
      // TextEvent With Drug
      if (yPosition > oceanHorizontalLine) {
        /* eslint-disable */console.log(...oo_oo(`2694664437_2`, "WITH CANVAS DRAG :: Back-End Developr"));
      } else {
        /* eslint-disable */console.log(...oo_oo(`2694664437_3`, "WITH CANVAS DRAG :: Front-End Developr"));
      }
    }
  }
  // 2. Touch Event 
